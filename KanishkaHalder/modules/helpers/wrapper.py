                ...
                button = [
                    [
                        InlineKeyboardButton(
                            "💥 Deploy Kanishka Userbot ✨",
                            url=f"https://github.com/CoderXKrishna/Kanishka-Userbot"
                        )
                    ]
                ]
                    ...
                    results=[
                        (
                            InlineQueryResultPhoto(
                                photo_url=f"https://telegra.ph/file/86ebf7e7bda084fb3a4cf.png",
                                title="🥀 Kanishka Userbot ✨",
                                thumb_url=f"https://telegra.ph/file/45f81fc83f1857b555e7d.png",
                                description=f"🌷 Deploy Your Own Kanishka-Userbot 🌿...",
                                caption=f"<b>🥀 Welcome » To » Kanishka 🌷\n✅ Userbot {__version__} ✨...</b>",
                        ...
                        (
                            InlineQueryResultArticle(
                                ...
                                input_message_content=InputTextMessageContent(
                                    f"||**🥀 Please, Deploy Your Own Kanishka Userbot❗...\n\nRepo:** <i>https://github.com/CoderXKrishna/Kanishka-Userbot/</i>||"
                                ),
                            )
                        )
                    ],
